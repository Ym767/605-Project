...
tslength=length(knn1$model$ts)
ts=knn1$model$ts[(tslength-199):tslength]

prediction=knn1$prediction

png(file=pngname,width = 960,height=600)

plot(ts,pch=20,type='o',ylab='stock price', xlab='day',xlim=c(1,250),main=mainname)
points(201:240,prediction,type='o', col='red',pch=20)
points(201:220,testpoint,type='o', col='blue',pch=20)
