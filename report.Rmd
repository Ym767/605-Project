...
```
## Group 9: Jiayang Wang, Xilin Qiao, Yeming Wei, Zhanpeng Xu, Zheming Cao
...
#### Since the testing and prediction points shown in this graph are mostly matched, we can trust our predictions. The picture shows that this stock price will be relatively stable in the future.
...
#### The graph shows that the blue and red lines are in opposite directions and do not overlap at all, which indicates that our predictions are sometimes invalid.
...
GitHub link: https://github.com/Ym767/605-Project